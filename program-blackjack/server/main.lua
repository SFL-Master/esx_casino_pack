...
AddEventHandler('program-blackjack:pickWinner', function()
    ...
    elseif player1result > 21 and player2result <= 21 then
        TriggerClientEvent('esx:showNotification', player1.source, '~y~Der Spieler vom zweiten Stuhl gewann das Spiel~s~!')
        TriggerClientEvent('esx:showNotification', player2.source, '~y~Der Spieler vom zweiten Stuhl gewann das Spiel~s~!')
        TriggerClientEvent('esx:showNotification', croupier.source, '~y~Der Spieler vom zweiten Stuhl gewann das Spiel~s~!')
        societyAccount.addMoney(bet*0.2)
        player2.addMoney(bet*1.8)
    elseif player2result > 21 and player1result <= 21 then
        TriggerClientEvent('esx:showNotification', player1.source, '~y~Spieler vom ersten Stuhl hat gewonnen~s~!')
        TriggerClientEvent('esx:showNotification', player2.source, '~y~Spieler vom ersten Stuhl hat gewonnen~s~!')
        TriggerClientEvent('esx:showNotification', croupier.source, '~y~Spieler vom ersten Stuhl hat gewonnen~s~!')
        societyAccount.addMoney(bet*0.2)
